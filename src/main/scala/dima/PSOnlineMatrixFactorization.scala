...
object PSOnlineMatrixFactorization {
  ...
  def psOnlineMF(src: DataStream[Rating], numFactors: Int = 10, rangeMin: Double = -0.01, rangeMax: Double = 0.01,
                 learningRate: Double, pullLimit: Int = 1600, workerParallelism: Int, psParallelism: Int,
